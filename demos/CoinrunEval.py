...
from dizoo.procgen.config.coinrun_dqn_config import main_config, create_config
...
def main(cfg, seed=0):
    ...
    cfg.policy.load_path = '/home/liwen/PycharmProjects/DI-engine/dizoo/procgen/config/default_experiment/ckpt/iteration_165000.pth.tar'
    ...
    evaluator_env.enable_save_replay(replay_path='./coinrun_dqn_eval/video')
